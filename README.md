...
# casosprueba2 <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
-   [`DESCRIPTION`](https://github.com/avallecam/casosprueba2/tree/main/DESCRIPTION):
    contains project metadata (authors, date, dependencies, etc.)

-   [`make.R`](https://github.com/avallecam/casosprueba2/tree/main/make.R):
    main R script to run the entire project

-   [`R/`](https://github.com/avallecam/casosprueba2/tree/main/R):
...
Guidelines](https://github.com/avallecam/casosprueba2/blob/main/CONTRIBUTING.md).
